...
<li id="output"></li>
   <?php
   		if (isset($_SESSION['pb'])) {
   			$link=array("","add_siswa","siswa","absen","absensi","req_catatan","catatan", "katasandi&id=$_SESSION[id]", "upload.php", "keluar");
			$name=array("","Tambah Karyawan","Daftar Karyawan","Absen","Lihat Absensi","Catatan","Lihat Catatan","Ubah Katasandi", "Upload File", "Keluar");
			...
			$link=array("","absen","absensi", "download.php", "keluar");
			$name=array("","Absen","Absensiku", "Download Slip Gaji", "Keluar");
