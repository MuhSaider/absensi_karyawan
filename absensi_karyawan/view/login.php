...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
  <div class="main-logo" style="display: flex; justify-content: center; flex-direction: column; align-items: center; text-align: center;">
  <img src="logo.png" alt="logo" style="width: 150px;">
  <h2 class="form-signin-heading">SELAMAT DATANG DI WEBSITE PT. KALDU SARI NABATI</h2>
</div>
    <div class="container">
