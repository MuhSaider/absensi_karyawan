<h3 class="page-header">Tambah Karyawan Nabati</h3>
<?php 
	if (isset($_GET['st'])) {
		if ($_GET['st']==1) {
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">NIK KARYAWAN:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="sekolah">Departement</label>
    <div class="col-sm-10">
