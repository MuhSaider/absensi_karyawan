<?php 
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="sekolah">Nama Departemen:</label>
    <div class="col-sm-10">
      <input type="text" value="<?php echo $sklh_user; ?>" class="form-control" name="sklh" placeholder="Masukan Nama Departemen" required>
    </div>
  </div>
  <div class="form-group">
